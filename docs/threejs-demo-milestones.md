...
- `romfs/apps/ThreeJSDemos/<name>/index.html` — title + lead +
  `<canvas id="...">` at 640×360 + status canvas + pre-flight 2D
  marker + script tags.
- `romfs/apps/ThreeJSDemos/<name>/assets/main.js` — scene logic.
  All deviations from upstream are comment-tagged in the file header.
- Shared libs live under `romfs/apps/ThreeJSDemos/libs/`
...
- Add a row to [`romfs/apps/ThreeJSDemos/index.html`](../romfs/apps/ThreeJSDemos/index.html).
...
- `Image.src` doesn't honour `brewser://` — use the sdmc:/ path.
...
[`romfs/apps/ThreeJSDemos/libs/harness.js`](../romfs/apps/ThreeJSDemos/libs/harness.js).
