...
const dirtyLiveElements = new Set();
export function markLiveDirty(el) {
    if (!el)
        return;
    ...
    if (toolbarMutationScopeDepth > 0)
        return;
...
export function markPageHasCanvas2dActivity() { pageHasCanvas2dActivityFlag = true; }
export function hasPageCanvas2dActivity() { return pageHasCanvas2dActivityFlag; }
export function clearPageHasCanvas2dActivity() { pageHasCanvas2dActivityFlag = false; }
export function setKeyboardOpen(v) {
    keyboardOpen = !!v;
    if (!v)
        pendingFullRepaint = true;
}
export function isKeyboardOpen() { return keyboardOpen; }
...
let keyboardLiveRoot = null;
let keyboardOverlayVisible = false;
export function setKeyboardLiveRoot(root) {
    keyboardLiveRoot = root;
}
export function getKeyboardLiveRoot() { return keyboardLiveRoot; }
export function setKeyboardOverlayVisible(v) {
    keyboardOverlayVisible = !!v;
    if (!v)
        pendingFullRepaint = true;
}
export function isKeyboardOverlayVisible() { return keyboardOverlayVisible; }
...
let keyboardTopY = null;
export function setKeyboardTopY(v) {
...
let kbTreeVersion = 0;
export function pushKbMutationScope() { kbMutationScopeDepth++; }
export function popKbMutationScope() {
    if (kbMutationScopeDepth > 0)
        kbMutationScopeDepth--;
}
export function inKbMutationScope() { return kbMutationScopeDepth > 0; }
export function bumpKbTreeVersion() { kbTreeVersion++; }
export function getKbTreeVersion() { return kbTreeVersion; }
...
export function consumeFullRepaintRequest() {
...
// =========================================================================
let toolbarLiveRoot = null;
let toolbarOverlayVisible = false;
export function setToolbarLiveRoot(root) {
    toolbarLiveRoot = root;
}
export function getToolbarLiveRoot() { return toolbarLiveRoot; }
export function setToolbarOverlayVisible(v) {
    toolbarOverlayVisible = !!v;
    if (!v)
        pendingFullRepaint = true;
}
export function isToolbarOverlayVisible() { return toolbarOverlayVisible; }
...
export function pushToolbarMutationScope() { toolbarMutationScopeDepth++; }
export function popToolbarMutationScope() {
    if (toolbarMutationScopeDepth > 0)
        toolbarMutationScopeDepth--;
}
export function inToolbarMutationScope() { return toolbarMutationScopeDepth > 0; }
export function bumpToolbarTreeVersion() { toolbarTreeVersion++; }
export function getToolbarTreeVersion() { return toolbarTreeVersion; }
// =========================================================================
...
export function pushModalMutationScope() { modalMutationScopeDepth++; }
export function popModalMutationScope() {
    if (modalMutationScopeDepth > 0)
        modalMutationScopeDepth--;
}
export function inModalMutationScope() { return modalMutationScopeDepth > 0; }
export function bumpModalTreeVersion() { modalTreeVersion++; }
export function getModalTreeVersion() { return modalTreeVersion; }
...
export function registerModalRoot(el) {
    modalRoots.add(el);
...
export function unregisterModalRoot(el) {
...
export function hasAnyModalRoot() { return modalRoots.size > 0; }
...
export function clearModalRoots() {
    if (modalRoots.size === 0 && modalModeDialogs.size === 0)
        return;
    modalRoots.clear();
    modalModeDialogs.clear();
    modalTreeVersion++;
    pendingFullRepaint = true;
}
// =========================================================================
...
// =========================================================================
const modalModeDialogs = new Set();
export function markDialogModalMode(el) { modalModeDialogs.add(el); }
export function unmarkDialogModalMode(el) { modalModeDialogs.delete(el); }
export function isDialogModalMode(el) { return modalModeDialogs.has(el); }
...
export function getModalModeDialogs() {
...
export function closeTopmostModalModeDialog() {
    if (modalModeDialogs.size === 0)
        return false;
...
//# sourceMappingURL=live-paint-control.js.map