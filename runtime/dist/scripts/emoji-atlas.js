...
export function getEmojiImage(key) {
...
export function emojiAssetFailed(key) {
...
export function matchEmojiClusterAt(s, i) {
    if (i >= s.length)
        return null;
    ...
    if (isKeycapBase(firstCp)) {
        let j = i + 1;
        if (j < s.length && s.charCodeAt(j) === VS16)
            j += 1;
...
//# sourceMappingURL=emoji-atlas.js.map