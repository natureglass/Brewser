...
//      points at the SDMC path (browser:// scheme rejected by Image).
...
try {
	...
	async function loadWaterTexture() {
		...
		await new Promise((resolve, reject) => {
			...
			img.src = 'sdmc:/switch/webprofiles/default/pages/threejs-demos/webgl-geometry-dynamic/assets/water.jpg';
		});
		const tw = img.width;
		const th = img.height;
