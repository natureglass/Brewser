...
try {
  ...
  // installs to route `browser://` URLs through `BrowserResourceLoader`.
  // So a `browser://...` Image src throws "scheme 'browser' not supported".
  ...
  await new Promise((resolve, reject) => {
    ...
    img.src = 'sdmc:/switch/webprofiles/default/pages/threejs-demos/geometry-cube/assets/crate.png';
  });
