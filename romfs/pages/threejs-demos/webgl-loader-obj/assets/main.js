...
//      `browser://` ([[nxjs-image-bypasses-global-fetch]]).
...
try {
	...
	const ASSET_PREFIX_SDMC =
		'sdmc:/switch/webprofiles/default/pages/threejs-demos/webgl-loader-obj/assets/';
	const ASSET_PREFIX_BROWSER =
		'browser://threejs-demos/webgl-loader-obj/assets/';
	...
	function init() {
		...
		loader.load(
			'browser://threejs-demos/webgl-loader-obj/assets/male02.obj',
			function ( obj ) {
