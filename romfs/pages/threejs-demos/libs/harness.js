...
//     `sdmc:/switch/webprofiles/default/khronos-logs/<test>.log` via
...
(function () {
  ...
  function writeSdmcLog() {
    ...
    try { Switch.mkdirSync('sdmc:/switch/webprofiles/default/khronos-logs/'); } catch (_) {}
    try {
      ...
      Switch.writeFileSync(
        'sdmc:/switch/webprofiles/default/khronos-logs/' + testName + '.log',
        header + log.join('\n') + '\n');
      return true;
    } catch (e) {
  ...
  globalThis.finishTest = function () {
    ...
    if (wrote) {
      appendLog('Log saved: sdmc:/switch/webprofiles/default/khronos-logs/' +
        testName + '.log');
