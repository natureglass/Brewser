...
//     rejects browser:// per [[nxjs-image-bypasses-global-fetch]])
...
//   loader.setPath('browser://threejs-demos/foo/assets/');
...
(function () {
	...
	class GLTFLoader {
		constructor() {
			...
			// instead of `globalThis.fetch(browser://...)`. Required for
			// r184 demos to dodge [[r184-fetch-hang]] — loading the r184
			// IIFE breaks all subsequent browser:// fetches.
