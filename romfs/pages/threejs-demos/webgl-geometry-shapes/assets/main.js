...
//      Image src points at the SDMC path (browser:// scheme is rejected
...
try {
	...
	await new Promise((resolve, reject) => {
		...
		img.src = 'sdmc:/switch/webprofiles/default/pages/threejs-demos/webgl-geometry-shapes/assets/uv_grid_opengl.jpg';
	});
	const tw = img.width;
	const th = img.height;
