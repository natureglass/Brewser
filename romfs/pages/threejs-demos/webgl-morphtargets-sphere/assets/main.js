...
try {
  ...
  async function loadMorphSphere() {
    const url = 'browser://threejs-demos/webgl-morphtargets-sphere/assets/morph-sphere.bin';
  ...
  async function loadDiscTexture() {
    ...
    await new Promise((resolve, reject) => {
      ...
      img.src = 'sdmc:/switch/webprofiles/default/pages/threejs-demos/webgl-morphtargets-sphere/assets/disc.png';
    });
    const tw = img.width;
    const th = img.height;
